...
?>  
  	<form class="form-horizontal anseve_form" method="post" action="<?php echo JRoute::_('index.php'); ?>">
    	<fieldset>
          ...
          <div class="anseve_group anseve_secure">
              <label class="anseve_label anseve_secure" for="secure_<?php echo $module->id; ?>">Honeypot</label>
              <input type="text" name="secure" placeholder="<?php echo $params->get("honeypottext") ?>" id="secure_<?php echo $module->id; ?>" class="anseve_control anseve_secure">
          </div>    
          <div class="anseve_group">   
            ...
            <?php endif; ?>
              <textarea name="message" required placeholder="<?php echo $params->get("messagetext"); ?>" class="anseve_control" id="message_<?php echo $module->id; ?>"><?php echo $message; ?></textarea>
          </div>
          ...
          <div class="anseve_group"> 
            ...
            <?php endif; ?>
              <div class="anseve_recaptcha" id="anseve_form_recaptcha">
              </div>
          </div>
          <?php endif; ?>
          ...
          <?php endif; ?> 
          <div class="anseve_group"> 
            <button type="submit" class="anseve_button"><?php echo $params->get("buttontext"); ?></button>
          </div>  
